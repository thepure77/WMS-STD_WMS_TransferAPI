...
{
    public class GoodsTransferExportService
    {
        ...
        public GoodsTransferExportService()
        {
        ...
        public GoodsTransferExportService(TransferDbContext db)
        {
            this.db = db;
        ...
        public GoodsTransferViewModel find(Guid id)
        {
            ...
            try
            {
                var queryResult = db.IM_GoodsTransfer.Where(c => c.GoodsTransfer_Index == id && c.DocumentType_Index == new Guid("9540E2AE-10A1-44CC-9FDF-53FF9AAB8D07")).FirstOrDefault();
        ...
        public actionResultGTViewModel filter(SearchGTModel model)
        {
            try
            {
                db.Database.SetCommandTimeout(3600);//set Time out

                var filterModel = new ProcessStatusViewModel();
                filterModel.process_Index = new Guid("79424DE2-9439-41D8-B203-52B0B2C4DFA8");
                ...
                query = query.Where(c => c.DocumentType_Index == new Guid("9540E2AE-10A1-44CC-9FDF-53FF9AAB8D07"));
                ...
                if (model.advanceSearch == true)
                {
                    ...
                    if (!string.IsNullOrEmpty(model.processStatus_Name))
                    {
                        ...
                        StatusModel.process_Index = new Guid("79424DE2-9439-41D8-B203-52B0B2C4DFA8");
        ...
        public GoodsTransferViewModel CreateGoodsTransferHeader(GoodsTransferViewModel data)
        {
            ...
            try
            {
                ...
                if (GoodsTransferOld == null)
                {
                    ...
                    filterModel.process_Index = new Guid("79424DE2-9439-41D8-B203-52B0B2C4DFA8");
                    filterModel.documentType_Index = new Guid("9540E2AE-10A1-44CC-9FDF-53FF9AAB8D07");
                    //GetConfig
                    //result = utils.SendDataApi<List<DocumentTypeViewModel>>(new AppSettingConfig().GetUrl("DropDownDocumentType"), filterModel.sJson());
        ...
        public actionResultPickbinbalanceViewModel pickProduct(PickbinbalanceViewModel model)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    GoodsTransferItem.Owner_Index = dataBinbalance.owner_Index;
                    GoodsTransferItem.Owner_Id = dataBinbalance.owner_Id;
                    GoodsTransferItem.Owner_Name = dataBinbalance.owner_Name;
                    GoodsTransferItem.Owner_Index_To = dataBinbalance.owner_Index;
                    GoodsTransferItem.Owner_Id_To = dataBinbalance.owner_Id;
                    GoodsTransferItem.Owner_Name_To = dataBinbalance.owner_Name;
                    ...
                    model.process_Index = "79424DE2-9439-41D8-B203-52B0B2C4DFA8";
                    ...
                    model.goodsReceive_EXP_Date = dataBinbalance.goodsReceive_EXP_Date.toString();
                    model.goodsReceive_MFG_Date = dataBinbalance.goodsReceive_MFG_Date.toString();
                    model.erp_Location = dataBinbalance.ERP_Location;
        ...
        public Boolean confirmDocument(GoodsTransferViewModel data)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    model.Template = "1";
                    GoodsTransferExportService assignService = new GoodsTransferExportService();
            ...
            try
            {
                ...
                foreach (var item in FindGT)
                {
                    ...
                    foreach (var listGTI in FindGTI)
                    {
                        ...
                        resultItem.MFG_Date = listGTI.GoodsReceive_MFG_Date;
                        resultItem.EXP_Date = listGTI.GoodsReceive_EXP_Date; 
        ...
        public Boolean confirmTransfer(GoodsTransferViewModel data)
        {
            ...
            try
            {
                var process_Index = new Guid("79424DE2-9439-41D8-B203-52B0B2C4DFA8");
                ...
                foreach (var items in GoodsTransferItem)
                {
                    ...
                    olog.logging("confirmStatus", "dataBinbalance :" + dataBinbalance.ToString());
                    ...
                    if ((items.Location_Id != items.Location_Id_To) || (items.ItemStatus_Id != items.ItemStatus_Id_To) || (items.Tag_No != items.Tag_No_To))
                    {
                        ...
                        if (!string.IsNullOrEmpty(_tag_Index) && items.TotalQty != dataBinbalance.binBalance_QtyBal)
                        {
                            ...
                            if (dataBinbalance.binBalance_QtyBal != items.Qty && dataBinbalanceReserve.binBalance_QtyBal != dataBinbalanceReserve.binBalance_QtyReserve)
                            {
                                ...
                                item.mfg_Date_To = dataBinbalance.goodsReceive_MFG_Date.toString();
                                item.exp_Date_To = dataBinbalance.goodsReceive_EXP_Date.toString();
                                item.tagRef_No1 = "";
                                item.tagRef_No2 = "";
                                item.tagRef_No3 = "";
                                item.tagRef_No4 = "";
                            ...
                            if (checkLocationStaging == null)
                            {
                                var binCardModel = new
                                {
                                    ...
                                    mfg_Date_To = dataBinbalance.goodsReceive_MFG_Date,
                                    exp_Date_To = dataBinbalance.goodsReceive_EXP_Date,
        ...
        public string GetReport(GoodsTransferViewModel model, string rootPath = "")
        {
            ...
            try
            {
                ...
                foreach (var G in GTI)
                {
                    ...
                    data.qty = G.TotalQty == null ? 0 : G.TotalQty.sParse<decimal>();
