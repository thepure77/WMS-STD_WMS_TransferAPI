...
{
    [Route("api/TransferExport")]
    [ApiController]
    public class GoodsTransferExportController : Controller
    {
        private readonly IHostingEnvironment _hostingEnvironment;

        public GoodsTransferExportController(IHostingEnvironment hostingEnvironment)
        {
        ...
        public IActionResult find(Guid id)
        {
            try
            {
                var service = new GoodsTransferExportService();
